...
import { Activites_data } from "../Data";
            ...
            >
              ...
              <div className="flex justify-between w-full mt-6">
                <div className="flex flex-col gap-4">
                  <p className="font-bold">{element.activity.length>15 ? `${element.activity.slice(0,15)}...` : element.activity}</p>
